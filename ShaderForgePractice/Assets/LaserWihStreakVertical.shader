...
////// Emissive:
                ...
                float3 emissive = (_GlowColor.rgb+pow((abs((frac((i.uv0+(node_1299.g*float2(_Xspeed,_Yspeed))).g)-0.5))*2.0),_BulgeShape));
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 node_1299 = _Time + _TimeEditor;
                o.Emission = (_GlowColor.rgb+pow((abs((frac((i.uv0+(node_1299.g*float2(_Xspeed,_Yspeed))).g)-0.5))*2.0),_BulgeShape));
